...
public class Keys {
    ...
    public static final UniqueKey<ActivitiesRecord> ACTIVITIES_PKEY = Internal.createUniqueKey(Activities.ACTIVITIES, DSL.name("activities_pkey"), new TableField[] { Activities.ACTIVITIES.ITEM_ID }, true);
    ...
    public static final ForeignKey<ActivitylogsRecord, ActivitiesRecord> ACTIVITYLOGS__ACTIVITYLOGS_ITEM_ID_FKEY = Internal.createForeignKey(Activitylogs.ACTIVITYLOGS, DSL.name("activitylogs_item_id_fkey"), new TableField[] { Activitylogs.ACTIVITYLOGS.ITEM_ID }, Keys.ACTIVITIES_PKEY, new TableField[] { Activities.ACTIVITIES.ITEM_ID }, true);
