...
public class Categories extends TableImpl<CategoriesRecord> {
    ...
    /**
     * The column <code>public.categories.unit</code>.
     */
    public final TableField<CategoriesRecord, String> UNIT = createField(DSL.name("unit"), SQLDataType.VARCHAR(50), this, "");
    ...
    public ActivitiesPath activities() {
        if (_activities == null)
            _activities = new ActivitiesPath(this, null, Keys.ACTIVITIES__ACTIVITIES_CATEGORY_ID_FKEY.getInverseKey());
     ...
     * <code>public.activitytemplates</code> table
     */
    public ActivitytemplatesPath activitytemplates() {
        if (_activitytemplates == null)
            _activitytemplates = new ActivitytemplatesPath(this, null, Keys.ACTIVITYTEMPLATES__ACTIVITYTEMPLATES_CATEGORY_ID_FKEY.getInverseKey());
